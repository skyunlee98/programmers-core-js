...
for(const key of 'hellop javascript'){
...
const keys = Object.keys(obj); // 객체의 key를을 모아 새로운 배열을 '반환'하는 유틸 함수
// ['nickName', 'age']
...
const entries = Object.entries(obj) // 객체의 key, value를 모아key, value 한 쌍의 배열로 '반환'하는 유틸 함수
// [[key, value], [key, value]]
